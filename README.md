...
- **Синтетический шум поверх уже "полевых" записей компаундируется, а не насыщается**: на
  CN-Celeb доп. деградация добавляет ещё +3–5 п.п. к EER поверх и так высокого базового уровня
  (15.2% → 18–20%) — эффект качественно сильнее, чем на чистом VoxCeleb (+0.6–2.6 п.п.), т.е.
  модель ещё не "на потолке" даже при естественном шуме. На Common Voice ru EER-кривая по
